...
public class HybridHashJoin extends JoinImplementation {
     ...
     */
    private <T extends Output> JoinResult<T> join(final JoinResult<T> results) throws CanceledExecutionException {
...
//            return UnsortedJoinContainer.create(outputMode, this, false, false);
//        }
//
...
//            case ARBITRARY:
//                joinResults = UnsortedJoinContainer.create(outputMode, this, deduplicateResults, deferMatches);
//                break;
//            case LEFT_RIGHT:
//                joinResults = LeftRightSortedJoinContainer.create(outputMode, this, deduplicateResults,
//                    deferMatches);
//                break;
//            default:
...
//        boolean storeRowOffsets = !(joinResults instanceof UnsortedJoinContainer.Split || joinResults instanceof UnsortedJoinContainer.Combined) || deduplicateResults;
...
//                ? UnsortedJoinContainer.create(outputMode, this, false, false)
//                : LeftRightSortedJoinContainer.create(outputMode, this, false, false);
//
...
//        phase3(joinResults);
     ...
     * @throws CanceledExecutionException
     */
    private <T extends Output> boolean phase1(final JoinResult<T> joinResults) throws CanceledExecutionException {
...
//        joinResults.sortedChunkEnd();
     ...
     * @throws CanceledExecutionException
     */
    private <T extends Output> void phase2(final JoinResult<T> joinResults) throws CanceledExecutionException {
...
//        TODO joinResults.sortedChunkEnd();
     ...
     * @throws CanceledExecutionException
     */
    private <T extends Output> void phase3(final JoinResult<T> joinResults) throws CanceledExecutionException {
...
//        TODO m_progress.setBucketSizes(m_partitioner.m_probeBuckets, m_partitioner.m_hashBucketsOnDisk);
...
//            TODO probeBucket.join(hashBucket, joinResults);
            // TODO joinResults.sortedChunkEnd();
        }
    ...
    class DiskBackedHashPartitions {
        ...
        public <T extends Output> DiskBackedHashPartitions(final boolean storeRowOffsets, final JoinResult<T> results) {
        ...
        /**
         * @return pairs of partitions that have to be processed on disk
         */
